    ...
    <main className="min-h-full overflow-auto bg-background px-4 py-8 text-foreground md:px-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
          ...
          <ZenCard>
            <div className="flex flex-col gap-5">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <ZenButton variant="ink" onClick={() => setCommandOpen(true)}>
                  Abrir comando
                </ZenButton>
              </div>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <ZenCard key={`alert-card-${cardKey}`} className="min-h-64">
            <div className="flex flex-col gap-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <ZenButton variant="washi" onClick={() => setAlertOpen((value) => !value)}>
              ...
              <ZenAlert
                ...
                action={
                  <ZenButton variant="ink" onClick={() => setAlertOpen(false)}>
                    Fechar
                  </ZenButton>
                }
              >
          ...
          <ZenCard key={`enso-card-${ensoKey}`} tone="ink" className="min-h-64">
            <div className="flex h-full flex-col justify-between gap-5">
              ...
              <ZenButton variant="hanko" onClick={() => setEnsoKey((value) => value + 1)}>
        ...
        <section className="grid gap-4 lg:grid-cols-3">
          <ZenCard>
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <ZenButton variant="ink" data-hover-preview="true">
                    Ink hover
                  </ZenButton>
                  <ZenButton variant="washi" data-hover-preview="true">
                    Washi hover
                  </ZenButton>
                  <ZenButton variant="hanko" data-hover-preview="true">
                    Hanko hover
                  </ZenButton>
                </div>
              </div>
          ...
          <ZenCard>
            <div className="space-y-4">
              ...
              <ZenButton variant="washi" onClick={() => setCardKey((value) => value + 1)}>
                Reanimar card
              </ZenButton>
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-xs text-[color:var(--zen-muted)]">
                  Dan/Kyu, progresso e conquista em selo.
                </p>
              </div>
        ...
        <ZenCard>
          <div className="space-y-5">
            <div>
              ...
              <p className="text-xs text-[color:var(--zen-muted)]">
                Base visual reutilizável antes dos componentes específicos.
              </p>
            </div>
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <ZenPaper tone="ink" padding="sm" animated={false}>
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-[color:color-mix(in_oklch,var(--zen-washi)_72%,transparent)]">
                    Papel escuro para momentos de foco.
                  </p>
                </div>
              </ZenPaper>
            </div>
        ...
        <ZenCard>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-[color:var(--zen-muted)]">
                Estes são todos os componentes, SVGs e utilitários Zen criados até agora.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              {zenInventory.map((item) => (
                <span
                  key={item}
                  className="zen-paper border border-[color:var(--zen-border)] px-2.5 py-1 text-xs text-[color:var(--zen-ink)]"
                >
                  {item}
                </span>
              ))}
        ...
        <section className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
          <ZenCard>
            <div className="space-y-5">
              <div>
                ...
                <p className="text-xs text-[color:var(--zen-muted)]">
                  Toast, loading, skeleton, estados finais, tooltip e modal ritual.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <ZenButton variant="washi" onClick={() => setStateKey((value) => value + 1)}>
                  Reanimar estados
                </ZenButton>
                <ZenButton variant="ink" onClick={() => setModalOpen(true)}>
                  Abrir modal
                </ZenButton>
          ...
          <ZenCard>
            <div className="grid gap-3 sm:grid-cols-2">
              <ZenEmptyState title="Pergaminho vazio">
                Nenhum registro encontrado neste fluxo.
              </ZenEmptyState>
        ...
        <ZenCard>
          <div className="space-y-5">
            <div>
              ...
              <p className="text-xs text-[color:var(--zen-muted)]">
                Controles de entrada como pergaminho, foco em hanko e checkbox com selo.
              </p>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <ZenTextarea
                label="Observação"
                placeholder="Escreva como em um pergaminho..."
                className="md:col-span-2"
              />
              <ZenCheckbox
                defaultChecked
                label="Selar ritual"
                description="Marca visual com selo vermelho animado."
              />
            </div>
          </div>
        </ZenCard>
          ...
          <ZenCard>
            <div className="space-y-5">
              <div>
                ...
                <p className="text-xs text-[color:var(--zen-muted)]">
                  Assets vetoriais internos, sem imagem externa.
                </p>
              </div>
          ...
          <ZenCard tone="ink">
            <div className="space-y-5">
              <div>
                ...
                <p className="text-xs text-[color:color-mix(in_oklch,var(--zen-washi)_72%,transparent)]">
                  Os mesmos componentes respondem aos tokens CSS do tema ativo.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-2 text-xs">
                {[
                  ...
                  <div
                    key={label}
                    className="flex items-center gap-2 border border-[color:color-mix(in_oklch,var(--zen-washi)_22%,transparent)] p-2"
                  >
                    <span className="size-5 border border-[color:color-mix(in_oklch,var(--zen-washi)_35%,transparent)]" style={{ background: value }} />
                    <span className="uppercase text-[10px] text-[color:color-mix(in_oklch,var(--zen-washi)_78%,transparent)]">
                      {label}
                    </span>
                  </div>
                ))}
