    ...
    <div className="flex-1 w-full bg-background/50 px-4 py-8 md:px-8 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="border-b border-border pb-6">
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Explore o repositório de exercícios de leitura e diagnóstico React. Encontre bugs, closures obsoletas e melhore seu raciocínio lógico.
        </p>
      </div>
      ...
      {/* Challenges List (GitHub Issues style) */}
