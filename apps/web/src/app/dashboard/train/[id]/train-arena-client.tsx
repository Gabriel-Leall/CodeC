...
export default function TrainArenaClient({
  ...
  return (
    <div className="flex-1 w-full bg-background/50 flex flex-col max-w-7xl mx-auto p-4 md:p-6 gap-4 animate-in fade-in duration-300">
        ...
        <div className="lg:col-span-6 flex flex-col gap-4">
          <div className="flex-1 flex flex-col min-h-[350px] border border-border bg-card">
            <div className="bg-muted/30 border-b border-border px-4 py-2 flex items-center justify-between">
              <span className="text-3xs font-mono font-semibold text-muted-foreground flex items-center gap-1.5">
            ...
            <div className="flex-1 flex font-mono text-[11px] leading-relaxed overflow-auto select-text bg-muted/5 h-[400px]">
              <div className="py-4 pl-3 pr-2 text-right text-muted-foreground/35 border-r border-border select-none bg-muted/10 font-semibold w-10">
                {lines.map((_, i) => (
                  <div key={i}>{i + 1}</div>
                ))}
              </div>
        ...
        <div className="lg:col-span-4 flex flex-col">
          {submitting && !result ? (
            ...
            <form
              ...
              className="flex-1 flex flex-col border border-border bg-card p-5 gap-4 justify-between h-full"
            >
            ...
            <div className="flex-1 border border-border bg-card p-5 gap-4 flex flex-col justify-between overflow-y-auto max-h-[75vh]">
